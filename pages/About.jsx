  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        ...
        Hello,I'm <span className="blue-gradient_text font-semibold drop-shadow"> Aswin </span>
        
      </h1>

      <div>
        <p className="mt-5 flex flex-col gap-3 text-slate-500">
          Software Engineer based in Chennai, Specializing in technical education through hands-on learning and building applications.
        </p>
      </div>
